...
public:
  ...
  BOOL
  SetColumnHeader(const CString &strHeadings); // Set columns and their formats.
  ...
  void
  ResizeToFitParent(); // Resize the list control to occupy parent's client area
  ...
  BOOL
  EndEdit(BOOL bCommit = TRUE); // Commit/cancel text edit, hide the editbox
